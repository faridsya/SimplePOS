...
public class Supplier extends AppCompatActivity implements AbsListView.OnScrollListener {
    DataHelper dbHelper;
    private ListView listView;
    String[] daftar;
    ListSupplier adapter;
    ...
    public void datasupplier(String nama) {
        ...
        adapter = new ListSupplier(this,arraylist,20,10);
