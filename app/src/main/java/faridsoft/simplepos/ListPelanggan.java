...
public class ListPelanggan extends BaseAdapter {
    // Declare Variables
    DataHelper dbHelper;
    private int count;
    ...
    private int posisi;
    public ListPelanggan(Context context, List<datasupplier> datasupplier, int startCount, int stepNumber) {
                ...
                public void onClick(View v) {
                    ...
                    switch (v.getId()) {
                        case R.id.image_view2:
                            ...
                            popup.getMenuInflater().inflate(R.menu.menupelanggan,
                                    popup.getMenu());
                            popup.show();
                                ...
                                public boolean onMenuItemClick(MenuItem item) {
                                    ...
                                    switch (item.getItemId()) {
                                        case R.id.update:
                                            ...
                                            ((Pelanggan)mContext).apdet(kodekat);
                                            break;
                                        case R.id.hapus:
                                            new AlertDialog.Builder(mContext)
                                                    ...
                                                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                                        ...
                                                        public void onClick(DialogInterface arg0, int arg1) {
                                                            ...
                                                            db.execSQL("delete from t_pelanggan where c_idpelanggan = '"+kodekat+"'");
                                                            Toast.makeText(mContext, R.string.sukses, Toast.LENGTH_LONG).show();
                                                            if(mContext instanceof Pelanggan){
                                                                ((Pelanggan)mContext).datasupplier("");
                                                            }
                                                            EditText txtcari = (EditText) ((Pelanggan)mContext).findViewById(R.id.search);
                                                            txtcari.setText("");
